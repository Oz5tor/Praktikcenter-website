<div class="textCenter">
    <p><h3>Afsluttede/ Udløbet Projektor</h3><p>
</div>
<?php
...
<?php
    ...
    ?>
    <div class="textCenter"><p><b><?php echo $user_row['fName'].' '. $user_row['lName'].' Har ikke nogen Afsluttede/ Udløbet Projektor'; ?></b></p></div>
<?php
}
